...
typedef struct
{
    ...
    float phi0Rad;               /* 虚拟腿相对机体系几何角，单位 rad；控制腿角 theta 参考 SPR 状态定义。 */
    float legLengthVelocityMps;  /* 虚拟腿长变化速度，单位 m/s。 */
    float legSwingVelocityRadps; /* 虚拟腿几何角速度，等于 d(phi0)/dt，单位 rad/s。 */
 ...
 *
 * swingTorqueNm 的正方向跟随 SPR 状态定义，最终电机方向由 torqueScale 和实机测试确认。
 */
