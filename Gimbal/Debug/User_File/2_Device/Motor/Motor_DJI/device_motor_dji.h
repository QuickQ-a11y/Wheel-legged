...
/* 发射机构电机数组下标，顺序与 0x200 帧的电调 ID 递增一致。 */
typedef enum
{
    MOTOR_DJI_TRIGGER = 0, /* M2006 拨弹盘。 */
    MOTOR_DJI_FRIC_L,      /* M3508 左摩擦轮。 */
    MOTOR_DJI_FRIC_R,      /* M3508 右摩擦轮。 */
} motor_dji_index_t;
...
/**
 * @brief 解析一帧 DJI ESC 反馈并刷新对应发射机构电机状态。
 *
