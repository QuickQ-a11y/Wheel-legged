 ...
 * 所以 IA10B_ConvertSwitch 里低值判 UP、高值判 DOWN，不要"顺手改回来"。
 * 三个档位各距阈值 250，余量充足。
 */
 ...
 * "x 向右为正、y 向上为正" 同向，所以 IA10B_Axis 直接减中位即可，不加负号。
 *
 ...
 * 拨杆得在发射机里改开关配置，三条出路见 ../../../../CLAUDE.md。
 */
#define IA10B_CH_RIGHT_X 0U  /* CH1 */
#define IA10B_CH_RIGHT_Y 1U  /* CH2 */
#define IA10B_CH_LEFT_Y 2U   /* CH3 */
#define IA10B_CH_LEFT_X 3U   /* CH4 */
#define IA10B_CH_DIAL 4U     /* CH5，VrA，已确认 */
#define IA10B_CH_RIGHT_SW 8U /* CH9，SwC，唯一的三档开关，已确认 */
#define IA10B_CH_LEFT_SW 9U  /* CH10，SwD，默认两档，已确认 */
 ...
 */
#define IA10B_UART_RXINVERT UART_ADVFEATURE_RXINV_ENABLE
